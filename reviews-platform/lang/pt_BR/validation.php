...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'negative_email' => [
            'required' => 'O campo email para avaliações negativas é obrigatório.',
            'email' => 'O campo email para avaliações negativas deve ser um endereço de email válido.',
        ],
        'email' => [
    ...
    */
    ...
    'attributes' => [
        'name' => 'nome',
        'email' => 'email',
        'negative_email' => 'email para avaliações negativas',
        'password' => 'senha',
